...
INSERT INTO `authors` VALUES (1,'orhon','pamuk'),(2,'stefan','zweig'),(3,'yaşar','kemal'),(4,'doğan','cüceoğlu');
...
CREATE TABLE `books` (
  ...
  CONSTRAINT `books_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `authors` (`authorID`),
  CONSTRAINT `books_ibfk_2` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`categorieID`)
...
INSERT INTO `books` VALUES (6,'Masumiyet Müzesi',1,1,1),(7,'Kırmızı Saçlı Kadın',1,2,9),(8,'Bilinmeyen Bir Kadının Mektubu',2,3,5),(9,'Ağrı Dağı Efsanesi',3,4,2),(10,'Geliştiren Anne-Baba',4,3,3),(11,'Masumiyet Müzesi',1,1,3),(12,'Masumiyet Müzesi',1,1,3),(13,'Masumiyet Müzesi',1,1,3),(14,'Masumiyet Müzesi',1,1,3);
...
INSERT INTO `categories` VALUES (1,'hikaye'),(2,'roman'),(3,'psikolojik'),(4,'tarih');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fines` (
  `finesID` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `loans` (
  ...
  `normal_return_date` date DEFAULT NULL,
  PRIMARY KEY (`loanID`),
  KEY `user_id` (`user_id`),
  KEY `book_id` (`book_id`),
  CONSTRAINT `loans_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`userID`),
  CONSTRAINT `loans_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`bookID`)
...
INSERT INTO `loans` VALUES (2,1,6,'2025-11-27','2025-11-27','2025-12-12'),(3,1,6,'2025-11-27',NULL,'2025-12-12'),(4,1,7,'2025-11-27','2025-11-27','2025-12-12'),(5,1,6,'2025-11-27',NULL,'2025-12-12');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `stock_reducer` AFTER INSERT ON `loans` FOR EACH ROW begin
 update books 
 set stock=stock-1
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `stock_booster` AFTER UPDATE ON `loans` FOR EACH ROW begin
...
INSERT INTO `users` VALUES (1,'nurten','kaval','1407','nurtenkaval@gmail.com','student'),(2,'beste ','başak','1071','beste@gmail.com','student'),(3,'hakan','aydın','1234','hakanaydın@gmail.com','admin');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `fine_calculate`(in loanId int)
begin
declare late_day int;
declare fine_amount int;
select datediff(return_date, normal_return_date)
into late_day from loans where loanID=loanId;
if late_day>0 then set fine_amount=late_day*30;
insert into fines(loan_id,amount,paid)values(loanId,fine_amount,false);
end if;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `return_book_fines` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `return_book_fines`(in p_loan_id int)
begin 
update loans set return_date=curdate() 
where loanID=p_loan_id;
call fine_calculate( p_loan_id );
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `stock_controle` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `stock_controle`(in p_user_id int,in p_book_id int)
begin 
declare current_stock int;
select stock into current_stock from books where bookID = p_book_id;
if current_stock>0 then  
insert into loans(user_id, book_id, loan_date, normal_return_date)values(p_user_id, p_book_id, curdate(), date_add(curdate(), interval 15 day));
else select 'stok yok' as MESAJ;
end if;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2025-12-08 16:41:20
-- MySQL dump 10.13  Distrib 8.0.44, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-11-17 20:27:35',NULL),('diagnostics.include_raw','OFF','2025-11-17 20:27:35',NULL),('ps_thread_trx_info.max_length','65535','2025-11-17 20:27:35',NULL),('statement_performance_analyzer.limit','100','2025-11-17 20:27:35',NULL),('statement_performance_analyzer.view',NULL,'2025-11-17 20:27:35',NULL),('statement_truncate_len','64','2025-11-17 20:27:35',NULL);
...
-- Dump completed on 2025-12-08 16:41:22
